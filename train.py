python recognize_video.py#--dataset dataset --embeddings output/embeddings.pickle --detector face_models --embedding-model face_models/openface_nn4.small2.v1.t7 --recognizer output/recognizer.pickle --le output/le.pickle
